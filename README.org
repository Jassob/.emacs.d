...
** System directories
   ...
   #+begin_src emacs-lisp :tangle init.el
     (dolist (dir (list local-dir etc-dir cache-dir packages-dir))
...
** System files and backups
   ...
   #+begin_src emacs-lisp :tangle init.el
     (setq delete-old-versions -1
	   ...
	   auto-save-file-name-transforms `((".*" ,(concat cache-dir "auto-save-list/") t)))
   #+end_src
...
** DONE Haskell
   ...
   #+begin_src emacs-lisp :tangle init.el
     ...
     (use-package company-ghc :after haskell-mode :ensure t
       :config
