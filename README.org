  ...
  #+begin_src emacs-lisp :tangle init.el
    (setq org-capture-templates
          `(("t" "Tasks" entry
            ...
            ("E" "Energy" table-line
             (file+headline (concat org-directory "organizer.org") "Track energy")
            ...
            ("q" "Quick note" item
             (file+headline (concat org-directory "organizer.org") "Quick notes"))
            ...
            ("n" "Daily note" table-line
             (file+olp (concat org-directory "organizer.org") "Inbox")
