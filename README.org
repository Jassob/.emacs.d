...
** TODO Version control
   ...
   #+begin_src emacs-lisp :tangle init.el
     (use-package magithub :after magit
       ...
       (local--init-file-if-missing (concat etc-dir "magit-auth-file")
   ...
   #+begin_src emacs-lisp :tangle init.el
     ...
     in etc-dir/magithub-auth-file."
       (local--update-alist-file (concat etc-dir "magithub-auth-file")
				 (magithub--prompt-for-auth))
   #+end_src
...
* Communication
  ...
  #+begin_src emacs-lisp :tangle init.el
    (use-package weechat :commands (weechat-connect)
      :config
      (local--init-file-if-missing (concat etc-dir "weechat-auth-file.el")
  ...
  #+begin_src emacs-lisp :tangle init.el
    ...
    the user."
      (local--update-alist-file (concat etc-dir "weechat-auth-file.el")
				(weechat--prompt-for-auth)))
  #+end_src
